...
def evaluate_model(model, test_loader):
    """Evaluate model with smart post-processing for high accuracy and balanced predictions"""
    model.eval()
    ...
    for i, emotion in enumerate(emotions):
        ...
        # Define confidence thresholds - adjust these for accuracy vs balance tradeoff
        ...
        # SMART APPROACH: Keep high-confidence predictions as is
