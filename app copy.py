...
# Original gates based on benchmark analysis
# EMOTION_GATES = {
#     "Engagement": 0.10,
#     "Boredom": 0.45,
#     "Confusion": 0.10,
...
# These gates are more conservative to prevent overfitting and instability
# Original gates were too aggressive, leading to instability in predictions
EMOTION_GATES = {
...
SMOOTHING_WINDOW = 20  # Number of predictions to smooth over time

# System monitoring thresholds
CPU_HIGH_THRESHOLD = 80
CPU_MEDIUM_THRESHOLD = 65
GPU_HIGH_THRESHOLD = 80
GPU_MEDIUM_THRESHOLD = 65
...
# Resource pools
thread_pool = ThreadPoolExecutor(max_workers=min(4, psutil.cpu_count(logical=False) - 1))
PREDICTION_QUEUE = queue.Queue(maxsize=5)
RESULTS_BUFFER = deque(maxlen=SMOOTHING_WINDOW)

# Display frame rate control
DISPLAY_FPS = 24     # Target display FPS
PROCESS_FPS = 6     # Process fewer frames for better performance
            ...
            with ui.column().classes('webcam-container col-12 col-md-8'):
                ...
                with ui.row().classes('w-full q-mt-md'):
                    ...
                    def toggle_dark_mode():
                        ...
                        """)
                        print(f"Dark mode set to: {ui.dark_mode}")
        ...
        while True:
            if emotion_app.webcam_active:
                ...
                if frame is not None:
                    ...
                    should_process = (current_time - last_processing_time) >=   1 / PROCESS_FPS 
